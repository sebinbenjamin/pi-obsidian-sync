...
echo ""
echo "Next steps:"
echo "  1. Set up HTTPS via Tailscale on port 6984:"
echo "     sudo tailscale serve --bg --https 6984 http://127.0.0.1:5984"
echo ""
echo "  2. Verify from another device on your tailnet:"
echo "     curl https://<pi-hostname>.<tailnet>.ts.net:6984/"
echo ""
